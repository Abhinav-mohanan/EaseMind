            ...
            <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-6 lg:p-12">
                <div className="w-full max-w-md space-y-8">
                    ...
                    <div className="text-center space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-gray-500 text-sm">
                                Select how you'd like to use EaseMind - as a user seeking support or as a licensed psychologist
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-2 justify-center">
                        <button disabled className="px-6 py-2 text-sm rounded-full bg-gray-200 text-gray-400 cursor-not-allowed">
                            Login
                        </button>
                        <button disabled className="px-6 py-2 text-sm rounded-full bg-gray-200 text-gray-400 cursor-not-allowed">
                            Register
                    ...
                    <div className="space-y-4">
                        ...
                        >
                            ...
                            <div className="text-left text-black">
                                ...
                                <div className="text-sm opacity-90 text-gray-800">Seeking mental health support</div>
                            </div>
                        </button>
