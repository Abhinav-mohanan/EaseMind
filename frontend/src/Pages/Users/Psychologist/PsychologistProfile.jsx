...
import { FetchPsychologistDetail, FetchUserDetail, PsychologistProfileApi, UserProfileApi } from '../../../api/authApi'
...
const PsychologistProfile = () => {
    ...
    const calculateProgress = (personal, professional) => {
        ...
        const professionalFields = ['license_no', 'specialization', 'experience_years', 'license_certificate', 
            'experience_certificate', 'education_certificate','education','bio'];
    ...
    const handleSubmit = async(e) =>{
        ...
        try{
            await Promise.all([
                UserProfileApi(personalFormData),
                PsychologistProfileApi(formData)
            ])
    ...
    const isPersonalDataComplete = () => {
        return personalData.first_name && personalData.last_name && personalData.phone_number && 
               personalData.gender && personalData.date_of_birth;
    };
                                        ...
                                        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                                            <div className='space-y-6'>
                                                <div className='border-l-4 border-teal-500 pl-4'>
                                                    ...
                                                    <p className='text-lg text-gray-900 mt-1'>{personalData.first_name || 'Not provided'}</p>
                                                </div>
                                                <div className='border-l-4 border-teal-500 pl-4'>
                                                    <label className='text-sm font-medium text-gray-500 uppercase tracking-wide'>Last Name</label>
                                                    <p className='text-lg text-gray-900 mt-1'>{personalData.last_name || 'Not provided'}</p>
                                                </div>
                                                <div className='border-l-4 border-teal-500 pl-4'>
                                                    <label className='text-sm font-medium text-gray-500 uppercase tracking-wide'>Phone Number</label>
                                                    <p className='text-lg text-gray-900 mt-1'>{personalData.phone_number || 'Not provided'}</p>
                                                </div>
                                            </div>
                                            <div className='space-y-6'>
                                                <div className='border-l-4 border-teal-600 pl-4'>
                                                    <label className='text-sm font-medium text-gray-500 uppercase tracking-wide'>Gender</label>
                                                    <p className='text-lg text-gray-900 mt-1'>{personalData.gender || 'Not provided'}</p>
                                                </div>
                                                <div className='border-l-4 border-teal-600 pl-4'>
                                                    <label className='text-sm font-medium text-gray-500 uppercase tracking-wide'>Date of Birth</label>
                                                    <p className='text-lg text-gray-900 mt-1'>{personalData.date_of_birth || 'Not provided'}</p>
                                                </div>
                                                <div className='border-l-4 border-teal-600 pl-4'>
                                        ...
                                        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                                            <div className='space-y-6'>
                                                <div className='border-l-4 border-teal-600 pl-4'>
                                                    ...
                                                    <p className='text-lg text-gray-900 mt-1 max-h-30 overflow-y-auto pr-2'>{professionalData.bio || 'Not provided'}</p>
                                                </div>
                                                <div className='border-l-4 border-teal-600 pl-4'>
                                                    <label className='text-sm font-medium text-gray-500 uppercase tracking-wide'>Education</label>
                                                    <p className='text-lg text-gray-900 mt-1'>{professionalData.education  || 'Not provided'}</p>
                                                </div>
                                                <div className='border-l-4 border-teal-600 pl-4'>
                                                    <label className='text-sm font-medium text-gray-500 uppercase tracking-wide'>Specialization</label>
                                                    <p className='text-lg text-gray-900 mt-1'>{professionalData.specialization || 'Not provided'}</p>
                                                </div>
                                                <div className='border-l-4 border-teal-600 pl-4'>
                                                    <label className='text-sm font-medium text-gray-500 uppercase tracking-wide'>Years of Experience</label>
                                                    <p className='text-lg text-gray-900 mt-1'>{professionalData.experience_years || 'Not provided'}</p>
                                                </div>
                                            </div>
                                            <div className='space-y-6'>
                                                <div className='border-l-4 border-teal-500 pl-4'>
                                                    <label className='text-sm font-medium text-gray-500 uppercase tracking-wide'>License Number</label>
                                                    <p className='text-lg text-gray-900 mt-1'>{professionalData.license_no || 'Not provided'}</p>
                                                </div>
                                                <div className='border-l-4 border-teal-500 pl-4'>
                                                    <label className='text-sm font-medium text-gray-500 uppercase tracking-wide'>License Certificate</label>
                                                    {professionalData.license_certificate ? (
                                                        <a href={professionalData.license_certificate} target='_blank' rel='noopener noreferrer' className='text-teal-600 hover:text-teal-700 flex items-center mt-1'>
                                                            <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                <div className='border-l-4 border-teal-500 pl-4'>
                                                    <label className='text-sm font-medium text-gray-500 uppercase tracking-wide'>Experience Certificate</label>
                                                    {professionalData.experience_certificate ? (
                                                        <a href={professionalData.experience_certificate} target='_blank' rel='noopener noreferrer' className='text-teal-600 hover:text-teal-700 flex items-center mt-1'>
                                                            <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                <div className='border-l-4 border-teal-500 pl-4'>
                                                    <label className='text-sm font-medium text-gray-500 uppercase tracking-wide'>Education Certificate</label>
                                                    {professionalData.education_certificate ? (
                                                        <a href={professionalData.education_certificate} target='_blank' rel='noopener noreferrer' className='text-teal-600 hover:text-teal-700 flex items-center mt-1'>
                                                            <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                                            </svg>
                                                ...
                                                <div>
                                                    ...
                                                    {professionalData.license_certificate && (
                                                        <p className='text-sm text-gray-500 mt-2'>
                                                            Selected: {professionalData.license_certificate.name || 'File uploaded'}
                                                        </p>
                                                    )}
                                                </div>
                                                <div>
                                                    ...
                                                    {professionalData.experience_certificate && (
                                                        <p className='text-sm text-gray-500 mt-2'>
                                                            Selected: {professionalData.experience_certificate.name || 'File uploaded'}
                                                        </p>
                                                    )}
                                                </div>
                                                <div>
                                                    ...
                                                    {professionalData.education_certificate && (
                                                        <p className='text-sm text-gray-500 mt-2'>
                                                            Selected: {professionalData.education_certificate.name || 'File uploaded'}
                                                        </p>
                                                    )}
                                                </div>
                                            </div>
