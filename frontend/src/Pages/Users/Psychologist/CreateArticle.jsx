...
import { PenSquare,Trash2,BookOpen,Eye,Save,X,Plus,Calendar,User,Image,Search,Filter,} from 'lucide-react';
...
const CreateArticle = () => {
    ...
    const fetchArticles = async(page) =>{
     try{
        setIsLoading(true)
        const data = await PsyArticleFetch(page)
                                    ...
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <button
                                            onClick={() => {
                                                ...
                                                setEditingArticle(null);
                                                setNewArticle({ title: '', content: '', cover_image: null, category: '', status: 'draft', tags: '' });
                                                setImagePreview('');
                                            }}
                        ...
                        <div className="p-6">
                            ...
                            <div className="flex items-center space-x-4 mb-6">
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    <select className="px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500">
